#
# THIS TESTING CODE IS NOW INVALID BECAUSE APPLICATION IS USING DYNAMODB TO STORE DATA 
# THE CODE WAS WRITTEN ASSUMING THAT IT USES IN-MEMORY STORAGE TO STORE DATA
# 
